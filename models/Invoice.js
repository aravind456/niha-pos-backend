...
// Model-ah define pannunga (Mongoose error thavirkka condition add panniruken)
const Invoice = mongoose.models.Invoice || mongoose.model('Invoice', invoiceSchema);

// ==========================================
// 1. SAVE BILL API (நீங்கள் எழுதியது)
// ==========================================
...
// ==========================================
// 2. TODAY SALES API (Dashboard-க்காக)
// ==========================================
...
// ==========================================
// 3. SALES REPORT API (Sales Report Screen-க்காக)
// ==========================================
